...
execute as @a[scores={scout=1},tag=!scout] at @s if entity @e[type=#scouting:hostile,distance=..10] run tellraw @s {"text":"You are unable to go into scouting mode while enemies are nearby","color":"yellow"}
#Runs scout function
